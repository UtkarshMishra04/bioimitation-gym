...
from utils import interpolate_data_table
...
labels_force = ['right_'  + label for label in labels_wrench] +\
               ['left_' + label for label in labels_wrench]
...
trc_adapter = opensim.TRCFileAdapter()
interpolate_data_table(markers_task)  # not needed always
