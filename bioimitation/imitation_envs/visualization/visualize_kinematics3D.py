...
# %%
import os
from bioimitation.imitation_envs.utils.visualization_utils3D import read_from_storage
from bioimitation.imitation_envs.utils.visualization_utils3D import perform_muscle_analysis
from bioimitation.imitation_envs.utils.visualization_utils3D import plot_scone_kinematics
from bioimitation.imitation_envs.utils.visualization_utils3D import plot_scone_vertical_reactions
from bioimitation.imitation_envs.utils.visualization_utils3D import plot_scone_joint_moments
from bioimitation.imitation_envs.utils.visualization_utils3D import plot_scone_muscle_excitations
...
def visualize_performance(save_path):
    ...
    model_file = os.path.abspath('./bioimitation/imitation_envs/data/3D/scale/model_scaled.osim')
    ...
    side = 'r'
    muscles = ['abd', 'add', 'hamstrings', 'bifemsh', 'glut_max', 'iliopsoas',
