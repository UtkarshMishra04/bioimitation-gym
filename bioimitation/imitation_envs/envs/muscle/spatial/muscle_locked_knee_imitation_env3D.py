...
class MuscleLockedKneeImitationEnv3D(OsimEnv):
    def __init__(self,
                 config
                 ):
        ...
        self.cycle = 50  # Calculated steps for completion of one gait cycle
        # if self.test:
        ...
        super(MuscleLockedKneeImitationEnv3D,
    ...
    def step(self, action, obs_as_dict=False):
        ...
        return super(MuscleLockedKneeImitationEnv3D, self).step(self.curr_action, obs_as_dict)
