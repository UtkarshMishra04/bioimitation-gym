...
class MuscleWalkingImitationEnv3D(OsimEnv):
    def __init__(self,
                 config
                 ):
        ...
        super(MuscleWalkingImitationEnv3D,
    ...
    def step(self, action, obs_as_dict=False):
        ...
        return super(MuscleWalkingImitationEnv3D, self).step(self.curr_action, obs_as_dict)
