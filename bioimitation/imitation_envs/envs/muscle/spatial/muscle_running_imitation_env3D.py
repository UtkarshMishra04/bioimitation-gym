...
class MuscleRunningImitationEnv3D(OsimEnv):
    def __init__(self,
                 config
                 ):
        ...
        super(MuscleRunningImitationEnv3D,
    ...
    def step(self, action, obs_as_dict=False):
        ...
        return super(MuscleRunningImitationEnv3D, self).step(self.curr_action, obs_as_dict)
