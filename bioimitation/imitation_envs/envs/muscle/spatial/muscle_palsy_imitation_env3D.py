...
class MusclePalsyImitationEnv3D(OsimEnv):
    def __init__(self,
                 config
                 ):
        ...
        subject_dir = os.path.abspath('./bioimitation/imitation_envs/data/02905/02905_PRE')
        ...
        super(MusclePalsyImitationEnv3D,
    ...
    def step(self, action, obs_as_dict=False):
        ...
        return super(MusclePalsyImitationEnv3D, self).step(action, obs_as_dict)
