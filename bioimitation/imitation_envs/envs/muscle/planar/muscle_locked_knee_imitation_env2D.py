...
class MuscleLockedKneeImitationEnv2D(OsimEnv):
    def __init__(self,
                 config
                 ):
        ...
        super(MuscleLockedKneeImitationEnv2D,
    ...
    def step(self, action, obs_as_dict=False):
        ...
        return super(MuscleLockedKneeImitationEnv2D, self).step(action, obs_as_dict)
