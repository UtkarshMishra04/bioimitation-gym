...
class TorqueLockedKneeImitationEnv3D(OsimEnv):
    def __init__(self,
                 config
                 ):
        ...
        super(TorqueLockedKneeImitationEnv3D,
    ...
    def step(self, action, obs_as_dict=False):
        ...
        return super(TorqueLockedKneeImitationEnv3D, self).step(self.curr_action, obs_as_dict)
