...
class TorqueRunningImitationEnv3D(OsimEnv):
    def __init__(self,
                 config
                 ):
        ...
        super(TorqueRunningImitationEnv3D,
    ...
    def step(self, action, obs_as_dict=False):
        ...
        return super(TorqueRunningImitationEnv3D, self).step(self.curr_action, obs_as_dict)
