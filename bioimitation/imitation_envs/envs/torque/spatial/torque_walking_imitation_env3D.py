...
class TorqueWalkingImitationEnv3D(OsimEnv):
    def __init__(self,
                 config
                 ):
        ...
        super(TorqueWalkingImitationEnv3D,
    ...
    def step(self, action, obs_as_dict=False):
        ...
        return super(TorqueWalkingImitationEnv3D, self).step(self.curr_action, obs_as_dict)
