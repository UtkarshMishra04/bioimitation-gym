...
class TorqueJumpingImitationEnv2D(OsimEnv):
    def __init__(self,
                 config
                 ):
        ...
        q_desired_file = os.path.join(subject_dir,
                            'highjump_reference_data/task_Kinematics_q.sto')
        u_desired_file = os.path.join(subject_dir,
                            'highjump_reference_data/task_Kinematics_u.sto')
        body_pos_desired_file = os.path.join(
                            subject_dir, 'highjump_reference_data/task_BodyKinematics_pos_global.sto')
        body_vel_desired_file = os.path.join(
                            subject_dir, 'highjump_reference_data/task_BodyKinematics_vel_global.sto')
        ...
        super(TorqueJumpingImitationEnv2D,
    ...
    def step(self, action, obs_as_dict=False):
        ...
        return super(TorqueJumpingImitationEnv2D, self).step(self.curr_action, obs_as_dict)
