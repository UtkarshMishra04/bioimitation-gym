...
class TorqueRunningImitationEnv2D(OsimEnv):
    def __init__(self,
                 config
                 ):
        ...
        super(TorqueRunningImitationEnv2D,
    ...
    def step(self, action, obs_as_dict=False):
        ...
        return super(TorqueRunningImitationEnv2D, self).step(self.curr_action, obs_as_dict)
